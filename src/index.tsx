  ...
  books: [
    {
      ...
      name: "Path of Hope",
      link: "path-of-hope",
      description: "there will be the description",
    },
    {
      serial: 2,
      name: "Alchemy greatness",
      link: "path-of-hope",
      description: "there will be the description",
    },
    {
      serial: 3,
      name: "The agony of fear",
      link: "path-of-hope",
      description: "there will be the description",
    },
    {
      serial: 4,
      name: "Roar of the avenger",
      link: "path-of-hope",
      description: "there will be the description",
    },
  ],
  ...
  projects: [
    {
      name: "Tour agency",
      description:
        "This project represents a common structure of a touristic agency website. \n" +
    ...
    },
    {
      ...
      description:
        "This project was made during the “Project activity” discipline. It is an\n" +
...
function reducer(state = defaultState, action: reduxAction): any {
  switch (action.type) {
    case "ADD__POSTS":
